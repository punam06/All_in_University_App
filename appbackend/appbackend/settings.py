...
SECRET_KEY = 'django-insecure-cg#n$45)7!(f^4$*nak^&8)ceu)ij7r5hazld$r5+-rxo!3vv1'
...
INSTALLED_APPS = [
    ...
    'events_clubs.apps.EventsClubsConfig',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'maindb',       # Your database name (you'll create this soon)
        'USER': 'postgres',                 # Your PostgreSQL username (likely 'postgres')
